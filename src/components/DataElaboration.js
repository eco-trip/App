...
import { faSeedling, faFan, faLightbulb, faDroplet, faShower } from '@fortawesome/pro-solid-svg-icons';
		...
		<>
			...
			<div className="row my-5">
				<div className="col-4">
					...
					<p className="text-muted fs-10">{t('dataElaboration.watt')}</p>
				</div>

				<div className="col-4">
					<FontAwesomeIcon icon={faDroplet} size="2x" className="mb-2" />
					<p className="text-muted fs-10">{t('dataElaboration.cold_flow_rate')}</p>
					<h1 className="mb-0">{data.cold_flow_rate}</h1>
					<p className="text-muted fs-10">{t('dataElaboration.liters')}</p>
				</div>
				<div className="col-4">
